...
void TimerG0_IntArm_NoRepeat(uint16_t period, uint32_t prescale, uint32_t priority);

void TimerG0_Activate(uint16_t period, uint32_t prescale);
void TimerG0_Deactivate(void);
